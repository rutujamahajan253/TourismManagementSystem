                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="col-md-6" style="margin-bottom: 10px">
                                        <input type="text" class="form-control" id="firstname" placeholder="First name" name="efname" required>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="col-md-6" style="margin-bottom: 10px">
                                        <input type="text" class="form-control" id="lastname" placeholder="Last name" name="elname" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="col-md-6" style="margin-bottom: 10px">
                                        <input type="text" class="form-control" placeholder="Address" name="eaddress" required>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="col-md-6" style="margin-bottom: 10px">
                                        <input type="text" class="form-control" placeholder="City" name="ecity" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="mt-2 col-sm-6">
                                    <div class="col-md-6" style="margin-bottom: 10px">
                                        <input type="text" class="form-control" id="inputMobileNumber" name="emobile" placeholder="Mobile Number" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row mb-2">
                                <div class="mt-2 col-sm-6">
                                    <div class="col-md-6" style="margin-bottom: 10px">
                                        <input type="text" class="form-control" id="inputDestination" name="destination" placeholder="Input Destination" required>
                                    </div>
                                </div>
                            </div>
                            <br>
